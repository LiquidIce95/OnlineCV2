class Icon_button extends HTMLElement {
    ...
    constructor(parent: HTMLElement, child: HTMLElement, document: Document, window: Window, HoverColor: string, Color: string) {
        super();
        this.Parent = parent;
        this.Child = child;
    ...
    titleMouseOver(title: HTMLElement, icon: HTMLElement) {
    ...
    titleMouseOut(title: HTMLElement, icon: HTMLElement) {
